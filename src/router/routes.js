...
export default [
    ...
    {
        name: "About", path: '/about', component: getPageComponent(() => import(/* webpackChunkName: "about" */"@/views/About")), meta: {
            title: '关于我',
        }
    },
    {
        name: "Project", path: '/project', component: getPageComponent(() => import(/* webpackChunkName: "project" */"@/views/Project")), meta: {
            title: '项目&效果',
        }
    },
    {
    ...
    {
        name: "CategoryBlog", path: '/blog/cate/:categoryId', component: getPageComponent(() => import(/* webpackChunkName: "blog" */"@/views/Blog")), meta: {
            title: '文章',
        }
    },
    {
